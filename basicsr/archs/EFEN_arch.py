...
# model = EFEN(channels=48, num_DFEB=8, upscale_factor=4)  # 定义好的网络模型,实例化
# input = torch.randn(1, 3, 320, 180)  # x4
# # input = torch.randn(1, 3, 426, 240)  # x3
...
# --------------------------*****(RFDB-WOA+EMSSA)*8(48 channel)(320*180)*****----------------------------------#
# FLOPs:  42118318080.0 = 42.1G     # params:  342174.0 = 342.2K
# --------------------------*****(EBFB-SRB+EMSSA)*8(48 channel)(320*180)*****----------------------------------#
# FLOPs:  41056634880.0 = 41.1G     # params:  305310 = 305.3K
# --------------------------*****(EBFB+EMSSA)*8(48 channel)(320*180)*****----------------------------------#
...
# --------------------------*****EMSSA(only)*8(48 channel)(320*180)*****----------------------------------#
